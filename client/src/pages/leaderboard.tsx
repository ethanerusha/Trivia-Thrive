        ...
        <Card>
          <CardHeader className="bg-primary text-primary-foreground rounded-t-lg">
            <div className="grid grid-cols-12 gap-4 text-sm font-medium">
              ...
              <div className="col-span-2 text-center hidden sm:block">Members</div>
                ...
                {leaderboard.map((entry) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="col-span-2 text-center hidden sm:flex items-center justify-center gap-1 text-muted-foreground">
